...
t3 <- chopimg(df=df3, path="data/test/soil/", im)
...
train_grass_dir <- file.path(train_dir, "grass")
dir.create(train_grass_dir)
train_soil_dir <- file.path(train_dir, "soil")
dir.create(train_soil_dir)
validation_grass_dir <- file.path(validation_dir, "grass")
dir.create(validation_grass_dir)
validation_soil_dir <- file.path(validation_dir, "soil")
dir.create(validation_soil_dir)
test_grass_dir <- file.path(test_dir, "grass")
dir.create(test_grass_dir)
test_soil_dir <- file.path(test_dir, "soil")
dir.create(test_soil_dir)


files <- list.files("data/test/grass/", pattern = "png", full.names = TRUE)
file.copy(file.path(files[1:1000]), file.path(train_grass_dir)) 
file.copy(file.path(files[1001:1500]), file.path(validation_grass_dir)) 
file.copy(file.path(files[1501:2000]), file.path(test_grass_dir)) 


files <- list.files("data/test/soil/", pattern = "png", full.names = TRUE)
length(files) #9656
file.copy(file.path(files[1:1000]), file.path(train_soil_dir)) 
file.copy(file.path(files[1001:1500]), file.path(validation_soil_dir)) 
file.copy(file.path(files[1501:2000]), file.path(test_soil_dir)) 
...
```{r}
cat("total training grass images:", length(list.files(train_grass_dir)), "\n")

cat("total test dog images:", length(list.files(test_soil_dir)), "\n")
```
